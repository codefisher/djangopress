...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='page',
            name='template',
            field=models.ForeignKey(blank=True, to='pages.PageTemplate', null=True, on_delete=models.CASCADE),
        ),
        migrations.AlterField(
        ...
        migrations.AddField(
            model_name='pagefile',
            name='page',
            field=models.ForeignKey(related_name='files', to='pages.Page', on_delete=models.CASCADE),
        ),
    ]
