...
def format_template(text, context=None, *args, **kargs):
    ...
    if context == None:
        context = Context()
    return mark_safe(force_text(t.render(context), encoding='utf-8'))
